...
const ScrapSelector = ( {setSelectQuery} ) => {
    ...
    return (
        <div>
            <select value={selectedScrap} onChange={handleScrapChange}>
                {scraps.map((scrap) => (
            ...
            <button onClick={handleFetchScrapInfo} className="btn btn-primary mx-2">조회</button>
        </div>
    );
};
